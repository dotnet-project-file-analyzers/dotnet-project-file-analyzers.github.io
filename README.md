...
Currently, even if the ??proj file is added, any warnings generated by the package
are not shown in SonarCloud. To fix this, in addition to adding it as an additional file,
you can add it as content:
